        ...
        <div class="col-lg-10">
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white text-center">
                    ...
                    <p class="mb-0">One-time payment for lifetime access</p>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('checkout.process', $role) }}" method="POST" id="checkout-form">
                        @csrf
                        <div class="row">
                            <!-- Order Summary -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4 p-3 bg-white rounded">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                @if($role === 'client')
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Post unlimited jobs</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Hire freelancers</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Project management tools</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Secure payment system</li>
                                                @elseif($role === 'freelancer')
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Browse and bid on jobs</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Create service gigs</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Portfolio showcase</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Earnings dashboard</li>
                                                @elseif($role === 'vendor')
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Sell products online</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Inventory management</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Order tracking</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Analytics dashboard</li>
                                                @else
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Full platform access</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Browse marketplace</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Purchase products & services</li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                @else
                                    ...
                                    <div class="mb-4">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="terms">
                                                ...
                                                and understand this is a one-time payment for lifetime access to the {{ ucfirst($role) }} role.
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary">
                                            <i class="bi bi-arrow-left me-2"></i>Cancel and Return
                                        </a>
                                    </div>
                                @endif
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul>
                    <li>Pay the specified amount for lifetime role access (one-time payment)</li>
                    <li>Use the platform responsibly and in accordance with our guidelines</li>
                    <li>Follow all platform rules and community standards</li>
                    <li>Allow role activation after payment confirmation</li>
                    <li>Acknowledge that roles are non-transferable and tied to your account</li>
                </ul>
                <h6 class="mt-3">Refund Policy</h6>
                <p>Refunds are available within 30 days of purchase if you are unsatisfied with the role features, provided you have not substantially used the role features.</p>
