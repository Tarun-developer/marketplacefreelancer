...
@section('title', 'Bid Purchase Checkout')
        ...
        <div class="col-lg-10">
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white text-center">
                    <h2>Purchase Extra Bids</h2>
                    <p class="mb-0">Add {{ $pack }} bids to your account</p>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('freelancer.process-bid-checkout', $pack) }}" method="POST" id="checkout-form">
                        @csrf
                        <div class="row">
                            <!-- Order Summary -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4 p-3 bg-white rounded">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>{{ $pack }} additional bids</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Instant activation</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>No expiration</li>
                                                <li><i class="bi bi-check-circle-fill text-success me-2"></i>Use on any job</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8">
                                ...
                                @else
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <a href="{{ route('freelancer.buy-bids') }}" class="btn btn-outline-secondary">
                                            <i class="bi bi-arrow-left me-2"></i>Back to Bid Options
                                        </a>
                                    </div>
                                @endif
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6>Bid Purchase Terms</h6>
                <p>By completing this purchase, you agree to:</p>
                <ul>
                    <li>Pay the specified amount for the additional bids</li>
                    <li>Bids will be added to your account immediately after payment</li>
                    <li>Bids do not expire and can be used on any job</li>
                    <li>Purchases are non-refundable once bids are added</li>
                </ul>
