<!-- Freelancer-specific Profile Content -->
<div class="col-12">
    <div class="row">
        <!-- Services -->
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    @if($user->services->count() > 0)
                        ...
                        <a href="{{ route('freelancer.services.index') }}" class="btn btn-sm btn-outline-primary mt-2">View All Services</a>
                    @else
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="mb-0"><i class="bi bi-check-circle me-2"></i>Completed Jobs</h5>
                </div>
                <div class="card-body">
                    @php
                        $completedJobs = $user->spmProjects->where('status', 'completed')->count();
                    @endphp
                    <div class="text-center">
                        <h2 class="text-success">{{ $completedJobs }}</h2>
