                     ...
                     <div class="card-body">
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                 ...
                                 <div id="screenshots-preview" class="mt-2"></div>
                             </div>
                         </div>
                         <div class="row mt-3">
                             <div class="col-md-6">
                                 ...
                                 <div id="main-file-preview" class="mt-2"></div>
                             </div>
                             <div class="col-md-6">
                                 ...
                                 <div id="preview-file-preview" class="mt-2"></div>
                             </div>
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="card mb-3">
                     ...
                     <div class="card-body">
                         ...
                         <div class="mb-3">
                             ...
                             <textarea name="short_description" id="short_description" rows="3" class="form-control">{{ old('short_description') }}</textarea>
                         </div>
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" name="tags" id="tags" class="form-control" value="{{ old('tags') ? implode(', ', old('tags')) : '' }}">
                         </div>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="mb-3">
                         ...
                         <div class="row">
                             <div class="col-md-4">
                                 <div class="mb-3">
                                     ...
                                     <input type="number" name="standard_price" id="standard_price" class="form-control" value="{{ old('standard_price') }}" step="0.01">
                                 </div>
                             </div>
                             <div class="col-md-4">
                                 <div class="mb-3">
                                     <label for="professional_price" class="form-label">Professional Price ($)</label>
                                     <input type="number" name="professional_price" id="professional_price" class="form-control" value="{{ old('professional_price') }}" step="0.01">
                                 </div>
                             </div>
                             <div class="col-md-4">
                                 <div class="mb-3">
                                     <label for="extended_price" class="form-label">Extended Price ($)</label>
                                     <input type="number" name="extended_price" id="extended_price" class="form-control" value="{{ old('extended_price') }}" step="0.01">
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="mb-3">
                                     ...
                                     <input type="number" name="discount_percentage" id="discount_percentage" class="form-control" value="{{ old('discount_percentage') }}" min="0" max="100" step="0.01">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="mb-3 form-check">
                                     <input type="checkbox" name="is_flash_sale" id="is_flash_sale" class="form-check-input" {{ old('is_flash_sale') ? 'checked' : '' }}>
                                     <label for="is_flash_sale" class="form-check-label">Flash Sale</label>
                                 </div>
                                 <div class="mb-3 form-check">
                                     <input type="checkbox" name="is_free" id="is_free" class="form-check-input" {{ old('is_free') ? 'checked' : '' }}>
                 ...
                 <div class="card mb-3">
                     ...
                     <div class="card-body">
                         ...
                         <div class="mb-3">
                             ...
                             <textarea name="changelog" id="changelog" rows="4" class="form-control">{{ old('changelog') }}</textarea>
                         </div>
                         <div class="mb-3 form-check">
                             <input type="checkbox" name="has_feature_updates" id="has_feature_updates" class="form-check-input" {{ old('has_feature_updates') ? 'checked' : '' }}>
                         ...
                         <div class="mb-3">
                             ...
                             <input type="url" name="auto_update_url" id="auto_update_url" class="form-control" value="{{ old('auto_update_url') }}">
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="card mb-3">
                     ...
                     <div class="card-body">
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="mb-3 form-check">
                                     <input type="checkbox" name="has_support" id="has_support" class="form-check-input" {{ old('has_support') ? 'checked' : '' }}>
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <input type="number" name="support_duration" id="support_duration" class="form-control" value="{{ old('support_duration') }}" min="1">
                                 </div>
                                 <div class="mb-3">
                                     <label for="support_link" class="form-label">Support Link</label>
                                     <input type="url" name="support_link" id="support_link" class="form-control" value="{{ old('support_link') }}">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="mb-3 form-check">
                                     <input type="checkbox" name="has_refund_guarantee" id="has_refund_guarantee" class="form-check-input" {{ old('has_refund_guarantee') ? 'checked' : '' }}>
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <input type="number" name="refund_days" id="refund_days" class="form-control" value="{{ old('refund_days') }}" min="1">
                                 </div>
                                 <div class="mb-3">
                                     <label for="refund_terms" class="form-label">Refund Terms</label>
                                     <textarea name="refund_terms" id="refund_terms" rows="3" class="form-control">{{ old('refund_terms') }}</textarea>
                                 </div>
                             </div>
                         </div>
                     </div>
                 ...
                 <div class="card mb-3">
                     ...
                     <div class="card-body">
                         <div class="mb-3">
                             ...
                             <textarea name="team_members" id="team_members" rows="3" class="form-control" placeholder='[{"name": "John Doe", "role": "Developer"}]'>{{ old('team_members') }}</textarea>
                         </div>
                         <div class="mb-3">
                             <label for="author_commission" class="form-label">Author Commission (%)</label>
                             <input type="number" name="author_commission" id="author_commission" class="form-control" value="{{ old('author_commission') }}" min="0" max="100" step="0.01">
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="card mb-3">
                     ...
                     <div class="card-body">
                         ...
                         <div class="mb-3">
                             ...
                             <textarea name="seo_description" id="seo_description" rows="3" class="form-control">{{ old('seo_description') }}</textarea>
                         </div>
                         <div class="mb-3">
                             <label for="seo_keywords" class="form-label">SEO Keywords (comma separated)</label>
                             <input type="text" name="seo_keywords" id="seo_keywords" class="form-control" value="{{ old('seo_keywords') ? implode(', ', old('seo_keywords')) : '' }}">
                         </div>
                         <div class="mb-3">
             ...
             <div class="card">
                 ...
                 <div class="card-body">
                     <ul class="list-unstyled">
                         <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i>Use descriptive names and slugs</li>
                         <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i>Add relevant tags and categories</li>
                         <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i>Upload high-quality files</li>
                         <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i>Set appropriate pricing</li>
                         <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i>Configure SEO for better visibility</li>
                     </ul>
                 </div>
             </div>
         </div>
