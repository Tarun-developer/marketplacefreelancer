...
<head>
    ...
    <title>@yield('title', 'Client Dashboard') - MarketFusion</title>
    <!-- Bootstrap CSS -->
        ...
        <nav id="sidebar" class="sidebar bg-dark text-white vh-100 position-fixed">
            <div class="p-3 border-bottom border-secondary">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="mb-0" id="sidebar-title">Client Panel</h5>
            ...
            <div class="p-2">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="{{ route('client.dashboard') }}" class="nav-link text-white {{ request()->routeIs('client.dashboard') ? 'active bg-secondary' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('client.payments') }}" class="nav-link text-white">
