...
<head>
    ...
    <title>@yield('title', 'Client Dashboard') - {{ config('app.name', 'Marketplace') }}</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <!-- Projects Section -->
            <div class="menu-section">
                <div class="menu-section-title">Projects & Jobs</div>
                <a href="{{ route('client.jobs.index') }}" class="menu-item {{ request()->routeIs('client.jobs.index') || request()->routeIs('client.jobs.show') ? 'active' : '' }}">
                    <i class="bi bi-briefcase"></i>
                    <span>My Jobs</span>
                    @if(auth()->user()->jobs()->where('status', 'open')->count() > 0)
                        <span class="menu-badge">{{ auth()->user()->jobs()->where('status', 'open')->count() }}</span>
                    @endif
                </a>
                <a href="{{ route('client.jobs.create') }}" class="menu-item {{ request()->routeIs('client.jobs.create') ? 'active' : '' }}">
                    <i class="bi bi-plus-circle"></i>
                    <span>Post New Job</span>
                </a>
                <a href="{{ route('client.jobs.index') }}" class="menu-item">
            ...
            <!-- Marketplace Section -->
            <div class="menu-section">
                <div class="menu-section-title">Marketplace</div>
