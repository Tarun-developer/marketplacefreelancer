...
<head>
    ...
    <title>@yield('title', 'Vendor Dashboard') - {{ config('app.name', 'Marketplace') }}</title>
    ...
    <style>
        :root {
            ...
            --vendor-primary: #D69E2E;
            --vendor-accent: #F6AD55;
            --vendor-light: #FBD38D;
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-logo">
            ...
            <div class="sidebar-logo-text">Vendor Store</div>
        </div>
        ...
        <nav class="sidebar-menu">
            ...
            <!-- Account Section -->
            <div class="menu-section">
                <div class="menu-section-title">Store Settings</div>
                <a href="{{ route('profile.edit') }}" class="menu-item {{ request()->routeIs('profile.edit') ? 'active' : '' }}">
                    <i class="bi bi-shop-window"></i>
                    <span>Store Profile</span>
                </a>
                <a href="{{ route('vendor.documentation') }}" class="menu-item {{ request()->routeIs('vendor.documentation') ? 'active' : '' }}">
             ...
             <div class="top-bar-right">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" style="min-width: 200px;">
                        <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="bi bi-shop-window me-2"></i>Store Profile</a></li>
                        <li><a class="dropdown-item" href="{{ route('vendor.analytics') }}"><i class="bi bi-graph-up me-2"></i>Analytics</a></li>
                        <li><a class="dropdown-item" href="{{ route('vendor.earnings') }}"><i class="bi bi-currency-dollar me-2"></i>Earnings</a></li>
