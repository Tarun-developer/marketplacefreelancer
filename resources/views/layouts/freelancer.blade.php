...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-user">
             <img src="{{ auth()->user()->getFirstMediaUrl('avatar', 'thumb') ?: 'data:image/svg+xml;base64,' . base64_encode('<svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="#38B2AC"/><text x="24" y="30" font-family="Arial" font-size="20" font-weight="bold" text-anchor="middle" fill="white">F</text></svg>') }}"
                  alt="Avatar"
             ...
             <div class="top-bar-right">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" style="min-width: 200px;">
                        <li><a class="dropdown-item" href="{{ route('freelancer.profile') }}"><i class="bi bi-person me-2"></i>My Profile</a></li>
                        <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="bi bi-gear me-2"></i>Settings</a></li>
                        <li><a class="dropdown-item" href="{{ route('freelancer.earnings') }}"><i class="bi bi-currency-dollar me-2"></i>My Earnings</a></li>
